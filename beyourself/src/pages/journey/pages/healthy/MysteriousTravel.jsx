...
import heshui from 'assets/images/journey/zhuibei-jiesuo@2x.png'
import zaocan from 'assets/images/journey/yican-weijiesuo@2x.png'
import yundong from 'assets/images/journey/shanshi-weijiesuo@2x.png'
import tiaozhan from 'assets/images/journey/quangu-weijiesuo@2x.png'
import mixing from 'assets/images/journey/yinshi-weijiesuo@2x.png'
import pressToEnter from 'assets/images/presstoenter.png'

import axios from 'axios'

import heshuibg from 'assets/images/journey/yinshi-bj@2x.png'
...
export default class MysteriousTravel extends Component {
    ...
    componentDidMount(){
        ...
        axios({
            ...
            await this.setState({
                rA: res.data.list? res.data.list[3].rA:0,
                rB: res.data.list? res.data.list[3].rB:0
            })
        })
    }
}
