...
import mixin from 'assets/images/journey/mixing-weijiesuo@2x.png'
import pressToEnter from 'assets/images/presstoenter.png'

import axios from 'axios'

import heshuibg from 'assets/images/journey/heshui-bj@2x.png'
...
export default class MysteriousTravel extends Component {
            ...
            <Body display={this.props.display}>
                <Bg bgImg={heshuibg}> 
                    ...
                    <TaskList>
                        ...
                        <NavLink to='/mixin'>
                            <Task><img src={mixin} alt="" style={{height:'100%',width: '100%'}}/></Task>
                        </NavLink>
                        <Done>
                            <Word>密信</Word>
                            <Word>未解锁</Word>
    ...
    componentDidMount(){
        ...
        axios({
            ...
            await this.setState({
                rA: res.data.list? res.data.list[0].rA:0,
                rB: res.data.list? res.data.list[0].rB:0
            })
        })
    }
}
